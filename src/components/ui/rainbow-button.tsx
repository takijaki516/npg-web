...
export function RainbowButton({
  ...
  return (
    <Button
      variant={"link"}
      className={cn(
        "animate-rainbow group relative inline-flex cursor-pointer items-center justify-center border-0 bg-[length:200%] transition-colors [background-clip:padding-box,padding-box,border-box] [background-origin:border-box] [border:calc(0.01*1rem)_solid_transparent] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
