...
import {
  ...
  CommandItem,
  CommandList,
} from "../../../../from-next/src/components/ui/command";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from "../../../../from-next/src/components/ui/popover";
import { Button } from "../../../../from-next/src/components/ui/button";
import { WEIGHT_BODY_PARTS, WORKOUT_OPTIONS } from "../../../../from-next/src/lib/types/exercise.types";
